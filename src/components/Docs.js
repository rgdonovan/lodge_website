  ...
  return (
    <div className="flex flex-col text-raisin text-xl h-screen">
      <header className="sticky align-middle top-0 bg-white flex py-1.5 pl-2 items-center border-b border-gray-200">
        <img src={icon} alt="The lodge icon" className="w-14 p-2" />
      ...
      <div className="flex flex-col md:flex-row">
        <nav className="hidden md:block md:w-9/12 border-r border-gray-300">
          <ul className="text-gray-600">
            ...
            <li className="m-2 p-1.5 pl-6 rounded bg-gray-100">
              <a href="#">Expandable</a>
            </li>
        ...
        <div className="flex flex-col items-center">
          ...
          <main className="px-6 pb-12 flex flex-col">
            <div>
              ...
              <Link to="/#case-study" className="block my-8 text-cyan">Read our case study for more information about user data pipelines and to learn how we built Lodge.</Link>
            </div>
      ...
      <footer className="bg-raisin px-6 md:px-24 text-white h-96">
        ...
        <Link to="/#landing"><p className="block pb-8">Case Study</p></Link>
      </footer>
    </div>
